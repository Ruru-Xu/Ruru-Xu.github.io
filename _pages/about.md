...
<div class="home-top">
  <aside class="home-profile" aria-label="Profile">
    ...
    <div class="home-profile__links" aria-label="Profile links">
      <a href="mailto:Ruru.Xu@nyulangone.org"><i class="fas fa-envelope" aria-hidden="true"></i><span>Email:</span>Ruru.Xu@nyulangone.org</a>
  ...
  <div class="home-story">
    <div class="story">
      I grew up in Shandong, China, and did all my schooling there. I earned my Bachelor's degree in Computer Science in 2016. After graduation, I took a year off to travel on my own. In 2017, I moved to Shanghai and started my Master's degree at the Shanghai Institute of Computing Technology. In 2018, I joined Fudan University's Lab of Interactive Media Computing, where I spent two great years working with Professor <a href="https://cjinfdu.github.io/"><span>Cheng Jin</span></a> on computer vision projects related to autonomous driving. At the same time, throughout my three years of Master's study, I also worked as an intern at Shanghai Shen Teng Technology, where I worked on smart city projects. After finishing my Master's, I took another year off from academia. I volunteered during the COVID-19 pandemic, and then in 2021, I moved to Turkey to start my PhD in Computer Engineering at Istanbul Technical University with Professor <a href="https://sites.google.com/view/oksuzilkay/"><span>Ilkay Oksuz</span></a>. During my PhD, my research gradually moved from autonomous driving to medical imaging. I became interested in accelerated MRI reconstruction and started working with deep learning and reinforcement learning. In September 2026, I joined NYU Grossman School of Medicine as a Postdoctoral Fellow with Dr. <a href="https://iliasgiannakopoulos.com/"><span>Ilias Giannakopoulos</span></a>. Now I work on MRI motion correction and accelerated image reconstruction. Outside research, I enjoy cycling, hiking, and working out.
    </div>
  </div>
</div>
...
<section class="home-section research-section">
  ...
  <p>I am interested in developing machine-learning methods that make medical imaging more efficient and reliable. My current work focuses on MRI reconstruction and motion correction, while my earlier research in computer vision continues to shape how I approach medical image analysis.</p>
  <div class="interest-tags" aria-label="Research interests">
    <span>MRI Reconstruction</span>
...
<section class="home-section news-section">
  ...
  <div class="news-list">
    ...
    <div class="news-item">
      ...
      <p>Accepted a postdoctoral position at <strong>NYU Grossman School of Medicine</strong>.</p>
    </div>
    <div class="news-item">
      <span class="news-date">2026.04</span>
      <p>Successfully defended my PhD thesis, <em>Accelerated MRI Sampling and Reconstruction with Reinforcement Learning</em>, at Istanbul Technical University.</p>
    </div>
    <div class="news-item">
...
<span class="anchor" id="moments"></span>

<section class="home-section moments-section">
  <div class="section-heading">
    <h2>Moments</h2>
  </div>
...
<section class="home-section beyond-section">
  <div class="section-heading">
